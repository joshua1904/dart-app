...
from main.business_logic.singleplayer_game import get_game_context, get_left_points, add_round
...
class SingleplayerGameTests(TestCase):
    ...
    def test_get_game_context_with_rounds(self):
        ...
        self.assertEqual(context["average_score"], 81.7)  # 245 / 3 = 81.666... rounded to 81.7
    ...
    def test_add_round_invalid_checkout(self):
        ...
        self.assertEqual(status, GameStatus.PROGRESS.value)
        self.assertEqual(game.game_rounds.first().points, 0)  # Invalid checkout results in 0 points
